...
public class JwtTokenProvider {
	...
	@Value("${auth.jwt.token.secret-key:secret}")
	private String secretKey = "secret";
	
	@Value("${auth.jwt.token.expire-length:3600000}")
	...
	public String resolveToken(HttpServletRequest req) {
		...
		if (bearerToken != null && bearerToken.startsWith("Bearer ")) bearerToken = bearerToken.substring("Bearer ".length());
